                        ...
                        <form action="#">               
                            <div class="table-content table-responsive">
                                <table>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="product-thumbnail"><a href="#"><img src="{{ asset('/assets/frontend/uniqlo/images/product/4.png')}}" alt="product img" /></a></td>
                                        ...
                                        <tr>
                                            <td class="product-thumbnail"><a href="#"><img src="{{ asset('/assets/frontend/uniqlo/images/product/3.png')}}" alt="product img" /></a></td>
